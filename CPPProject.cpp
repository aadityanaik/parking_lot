...
public:
    parking_lot()                                       //constructor to initialise values of each spot in the lot;
    {
        for(int i = 0; i < 10; i++)
        {
            for(int j = 0; j < 10; j++)
...
void getdata(parking_lot *x, vehicle *y)                                    //takes input from the user
{
    ...
    cin >> (x -> time_allot);
    if (cin.fail())
    {                                                                       //cin function fails in the extraction process
...
void parking_lot::disp_lot()
{
    ...
    cout << "   ";
    for (n = 0; n < 10; n ++)
    {                                                                       //Printing column headings appropriately spaced
        cout << n + 1 << "  ";
    }
...
int main()
{
    ...
    parking_lot *FWslot = new parking_lot;
    parking_lot *TWslot = new parking_lot;
    int i = 0;
    ...
    start:
        ...
        case '1':
        	...
        	switch(vehicle_choice)
        	{
        		case '1':
        			...
        			slot4 -> disp_lot();
        			getdata(FWslot, (car + i));
                    break;

                case '2':
                	cout << "\t" << "\t" << "\t" << currenttime << endl;    //shows the time the function is called
        			slot2 -> disp_lot();
					getdata(TWslot, (bike+i));
					break;
			}
            break;
        ...
        case '2':
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                {
                    cout << "Thank you for using PARKINATOR parking systems. Your charge is INR " << car[i].charge()<<endl; //Sorry, couldn't think of a better name
